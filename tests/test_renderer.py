...
def test_summarize_frames_generates_html():
    ...
    # Verify indexing for all frames (0-indexed)
    assert "frame0" in html_output
    assert "frame1" in html_output
    assert "frame2" in html_output
    # Verify the class attribute using single quotes as generated by your code
...
def test_render_osm_maps_function(tmp_path):
    ...
    # Run main function
    render_osm_maps(input_file=str(input_file), output_dir=str(output_dir))
